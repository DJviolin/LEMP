...
ExecStart=/opt/bin/docker-compose --x-networking --x-network-driver=overlay --file $REPO_DIR/docker-compose.yml up --force-recreate
...
Run docker-compose with:\n\
  $ docker-compose --x-networking --x-network-driver=overlay --file $REPO_DIR/docker-compose.yml build\n\
