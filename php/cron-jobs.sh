...
while true; do
  ...
  /usr/local/php7/bin/php /var/www/pussybnb.com/wp-content/plugins/wp-cron-control/wp-cron-control.php http://127.0.0.1/pussybnb.com 48acdc227b8c6c3e2e82fc6a5cdbd771
  sleep 5m
done
